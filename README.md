...
- Clone the github repository
  ```shell
  $ git clone https://github.com/Anshukumarsrivastava/Semantic-Spotter.git
  ```
- Open
  the [notebook](https://github.com/Anshukumarsrivastava/Semantic-Spotter/blob/main/semantic-spotter-langchain-notebook.ipynb)
